...
| ![首页](./src/assets/images/首页.png) | ![回收地图](./src/assets/images/志愿者回收地图.png) |
| :---: | :---: |
| **主页：深海沉浸式 UI** | **回收地图：实时网点查询** |

| ![溯源查询](./src/assets/images/志愿者溯源查询.png) | ![积分商城](./src/assets/images/志愿者商城.png) |
| :---: | :---: |
| **区块链：透明化回收溯源** | **商城：环保成果兑换** |

| ![打卡签到](./src/assets/images/志愿者打卡.png) | ![志愿者社区](./src/assets/images/志愿者社区.png) |
| :---: | :---: |
| **打卡：记录每日环保行动** | **社区：分享环保心得** |

---

## 🏆 荣誉勋章体系

我们为积极参与环保的志愿者准备了精美的荣誉勋章，记录您的每一份贡献：

| ![分类达人](./src/assets/images/分类达人.png) | ![环保大师](./src/assets/images/环保大师.png) | ![海洋之友](./src/assets/images/海洋之友.png) |
| :---: | :---: | :---: |
| **分类达人** | **环保大师** | **海洋之友** |
...
- **AI 垃圾分类**：集成 **阿里云图像识别 API**，拍照即可智能识别塑料种类，指导精准投放。

### 3. 🔗 区块链概念溯源
- **真实存证**：模拟区块链技术，为每一笔回收行为生成唯一批次号与哈希校验码，确保回收记录真实不可篡改。
- **成就换算**：基于回收重量精准计算环保贡献，将回收行为转化为可视化的碳减排与资源节省数据。
