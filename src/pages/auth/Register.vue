  ...
  <div class="auth-container fade-in">
    ...
    <div class="auth-card glass-panel">
      ...
      <form @submit.prevent="handleRegister">
        ...
        <div class="input-group">
          <input type="email" placeholder="邮箱" v-model="form.email" required>
        </div>
        <div class="input-group">
          <input type="password" placeholder="密码" v-model="form.password" required>
        </div>
        <div class="input-group">
          <input type="password" placeholder="确认密码" v-model="form.confirmPassword" required>
        </div>
        <button type="submit" class="btn-primary full-width">立即注册</button>
